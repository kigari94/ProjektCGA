import * as CANNON from '../../../../lib/cannon-es-0.18.0/dist/cannon-es.js';
...
export default class Physics {
  ...
  addCube(object, mass, dimX, dimY, dimZ, velocityVector, offsetX = 0, offsetY = 0, offsetZ = 0, sleeping = false) {
